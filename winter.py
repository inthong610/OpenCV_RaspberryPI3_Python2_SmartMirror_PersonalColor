...
with picamera.PiCamera() as camera:
    ...
    camera.annotate_text = 'WInter Cool '
    time.sleep(1)

    # Load the arbitrarily sized image
    img = Image.open('winter1.png')
