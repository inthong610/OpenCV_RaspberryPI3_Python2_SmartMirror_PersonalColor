...
with picamera.PiCamera() as camera:
    ...
    camera.annotate_text = 'Spring Warm '
    time.sleep(1)

    # Load the arbitrarily sized image
    img = Image.open('spring1.png')
